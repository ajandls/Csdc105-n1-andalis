...
if (len(sys.argv) > 1):
	...
	print ('Usage: python3 ./andalis_e3.py <activity or sector> <quarantine classification>')
	exit ()
...
while True:
	...
	if first_argument.lower() == 'transport':
		if second_argument.lower() == 'ecq':
	...
	if first_argument.lower() == 'gatherings':
		if second_argument.lower() == 'ecq': 
	...
	if first_argument.lower() == 'schools':
		if second_argument.lower() == 'ecq': 
	...
	if first_argument.lower() == 'government':
		if second_argument.lower() == 'ecq':
